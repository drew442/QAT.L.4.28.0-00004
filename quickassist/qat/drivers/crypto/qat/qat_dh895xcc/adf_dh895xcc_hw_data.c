...
static int adf_check_uncorrectable_error(struct adf_accel_dev *accel_dev)
{
	...
	u32 errsou0 = ADF_CSR_RD(csr, ADF_ERRSOU0);
	u32 errsou1 = ADF_CSR_RD(csr, ADF_ERRSOU1);
	u32 errsou3 = ADF_CSR_RD(csr, ADF_ERRSOU3);
	u32 errsou4 = ADF_CSR_RD(csr, ADF_ERRSOU4);
	u32 errsou5 = ADF_CSR_RD(csr, ADF_ERRSOU5);

	u32 errmsk0 = ADF_CSR_RD(csr, ADF_ERRMSK0);
	u32 errmsk1 = ADF_CSR_RD(csr, ADF_ERRMSK1);
	u32 errmsk3 = ADF_CSR_RD(csr, ADF_ERRMSK3);
	u32 errmsk4 = ADF_CSR_RD(csr, ADF_ERRMSK4);
	u32 errmsk5 = ADF_CSR_RD(csr, ADF_ERRMSK5);

	errsou0 = errsou0 & ~(errmsk0) & ADF_DH895XCC_ERRMSK0_UERR;
	errsou1 = errsou1 & ~(errmsk1) & ADF_DH895XCC_ERRMSK1_UERR;
	errsou3 = errsou3 & ~(errmsk3) & ADF_DH895XCC_ERRMSK3_UERR;
	errsou4 = errsou4 & ~(errmsk4) & ADF_DH895XCC_ERRMSK4_UERR;
	errsou5 = errsou5 & ~(errmsk5) & ADF_DH895XCC_ERRMSK5_UERR;
